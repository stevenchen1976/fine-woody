...
public interface MobileCodeWSSoap {
    ...
    @RequestWrapper(localName = "getMobileCodeInfo", targetNamespace = "http://WebXml.com.cn/", className = "com.woody.framework.ws.cxfspring.client.mobileInfo.GetMobileCodeInfo")
    @ResponseWrapper(localName = "getMobileCodeInfoResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.woody.framework.ws.cxfspring.client.mobileInfo.GetMobileCodeInfoResponse")
    ...
    @RequestWrapper(localName = "getDatabaseInfo", targetNamespace = "http://WebXml.com.cn/", className = "com.woody.framework.ws.cxfspring.client.mobileInfo.GetDatabaseInfo")
    @ResponseWrapper(localName = "getDatabaseInfoResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.woody.framework.ws.cxfspring.client.mobileInfo.GetDatabaseInfoResponse")
